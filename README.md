...
7. Send the JAR using the command: `java --add-opens java.base/jdk.internal.loader=ALL-UNNAMED -jar xploit/target/xploit-[version].jar <ps5 ip address>`. PS5 should inform on screen about status of the upload and the execution.
